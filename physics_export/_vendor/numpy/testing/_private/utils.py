...
from .... import numpy
from ....numpy import linalg as ___vendorize__0
numpy.linalg = ___vendorize__0
from ....numpy.linalg import _umath_linalg as ___vendorize__1
numpy.linalg._umath_linalg = ___vendorize__1
